...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public static PCD gerarPCDAleatorio(User user) {
        ...
        informationDeficiency.setDeficiency(DeficiencyType.values()[random.nextInt(DeficiencyType.values().length)]);

        return new PCD(null, nome, cpf, dataNascimento, telefone, email, genero, escolaridade, race, null, null, null, null, null, random.nextBoolean(), random.nextBoolean(), endereco, null, informationDeficiency, user);
    }
