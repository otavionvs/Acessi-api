...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    private static final List<String> cidades = Arrays.asList("São Paulo", "Rio de Janeiro", "Belo Horizonte", "Salvador", "Fortaleza", "Curitiba", "Manaus", "Recife");
    ...
    private static final List<String> bairros = Arrays.asList("Centro", "Jardim", "Vila", "Bairro Novo", "Morro");
    ...
    public static PCD gerarPCDAleatorio(User user) {
        ...
        Date dataNascimento = Date.from(LocalDate.of(random.nextInt(1950, 2024), random.nextInt(1, 13), random.nextInt(1, 28)).atStartOfDay(ZoneId.systemDefault()).toInstant());
